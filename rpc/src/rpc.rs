...
impl JsonRpcRequestProcessor {
    ...
    pub async fn get_multi_token_holders_number(
        &self,
        mints: Vec<Pubkey>,
        commitment: Option<CommitmentConfig>,
    ...
    pub async fn get_token_top_holders(
        ...
        let mut token_holders = BinaryHeap::<Reverse<(u64, Pubkey, Pubkey)>>::with_capacity(limit);
...
pub mod rpc_accounts_scan {
    ...
    pub trait AccountsScan {
        ...
        fn get_multi_token_holders_number(
            ...
            commitment: Option<CommitmentConfig>,
        ) -> BoxFuture<Result<RpcResponse<Vec<u64>>>>;
    ...
    impl AccountsScan for AccountsScanImpl {
        ...
        fn get_multi_token_holders_number(
            ...
            async move {
                let mints = mint_strs
                    .into_iter()
                    .map(|mint_str| verify_pubkey(&mint_str))
                    .collect::<Result<Vec<Pubkey>>>()?;
                meta.get_multi_token_holders_number(mints, commitment).await
            }
            .boxed()
        }
        fn get_token_holders_number(
        ...
        fn get_token_top_holders(
            ...
            debug!(
                "get_token_top_holders rpc request received: {:?}, limit: {:?}",
                mint_str, limit
            );
            async move {
                let mint = verify_pubkey(&mint_str)?;
                meta.get_token_top_holders(mint, limit, commitment).await
            }
            .boxed()
        }
